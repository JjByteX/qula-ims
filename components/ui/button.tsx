  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[var(--radius-sm)] [font-size:var(--text-sm)] font-semibold transition-colors disabled:pointer-events-none disabled:opacity-40 [&_svg]:size-4 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-[var(--destructive)] text-[#fffcfc] hover:opacity-90",
        link: "bg-transparent text-[var(--foreground)] underline-offset-4 hover:underline p-0 h-auto",
      },
      size: {
        default: "h-10 px-4",
        sm: "h-8 px-3 [font-size:var(--text-sm)]",
        lg: "h-12 px-6 [font-size:var(--text-base)]",
        icon: "size-10",
      },
    },
    defaultVariants: {
