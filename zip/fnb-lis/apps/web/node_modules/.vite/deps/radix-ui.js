...
import { C as createContextScope, S as useId, _ as FocusScope, a as DialogOverlay, b as Root$12, c as DialogTrigger, d as hideOthers, f as ReactRemoveScroll, g as dist_exports$17, h as Portal$4, i as DialogDescription, l as createDialogScope, m as Presence, n as DialogClose, o as DialogPortal, p as useFocusGuards, r as DialogContent, s as DialogTitle, t as Dialog, u as dist_exports$8, v as Branch, x as useCallbackRef, y as DismissableLayer } from "./dist-3LLsU04Z.js";
...
function setRef$34(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
function composeRefs$34(...refs) {
	return (node) => {
		let hasCleanup = false;
		const cleanups = refs.map((ref) => {
			const cleanup = setRef$34(ref, node);
		...
		if (hasCleanup) return () => {
			for (let i = 0; i < cleanups.length; i++) {
				...
				else setRef$34(refs[i], null);
			}
		};
	};
}
function useComposedRefs$34(...refs) {
	return import_react.useCallback(composeRefs$34(...refs), refs);
}
//#endregion
//#region ../../node_modules/@radix-ui/react-visually-hidden/node_modules/@radix-ui/react-slot/dist/index.mjs
// @__NO_SIDE_EFFECTS__
function createSlot$33(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$33(children) && typeof use$33 === "function") children = use$33(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$33(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$33(child) && typeof use$33 === "function") child = use$33(child._payload);
				slottableElement = getSlottableElementFromSlottable$33(slottable, child);
		...
		const slottableElementRef = slottableElement ? getElementRef$33(slottableElement) : void 0;
		const composedRef = useComposedRefs$34(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$33(ownerName) : createSlotError$33(ownerName));
			return children;
		}
		const mergedProps = mergeProps$33(slotProps, slottableElement.props ?? {});
...
var SLOTTABLE_IDENTIFIER$33 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$33 = (slottable, child) => {
...
function mergeProps$33(slotProps, childProps) {
...
function getElementRef$33(element) {
...
function isSlottable$33(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$33;
}
var REACT_LAZY_TYPE$33 = Symbol.for("react.lazy");
function isLazyComponent$33(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$33 && "_payload" in element && isPromiseLike$33(element._payload);
}
function isPromiseLike$33(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$33 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$33 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$33 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$32 = [
	...
	const Slot = /* @__PURE__ */ createSlot$33(`Primitive.${node}`);
...
var VisuallyHidden = import_react.forwardRef((props, forwardedRef) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$32.span, {
		...props,
		ref: forwardedRef,
		style: {
...
function setRef$33(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
function composeRefs$33(...refs) {
	return (node) => {
		let hasCleanup = false;
		const cleanups = refs.map((ref) => {
			const cleanup = setRef$33(ref, node);
			if (!hasCleanup && typeof cleanup == "function") hasCleanup = true;
			return cleanup;
		});
		if (hasCleanup) return () => {
			for (let i = 0; i < cleanups.length; i++) {
				const cleanup = cleanups[i];
				if (typeof cleanup == "function") cleanup();
				else setRef$33(refs[i], null);
			}
		};
	};
}
function useComposedRefs$33(...refs) {
	return import_react.useCallback(composeRefs$33(...refs), refs);
}
//#endregion
...
function createSlot$32(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$32(children) && typeof use$32 === "function") children = use$32(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$32(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$32(child) && typeof use$32 === "function") child = use$32(child._payload);
				slottableElement = getSlottableElementFromSlottable$32(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$32(slottableElement) : void 0;
		const composedRef = useComposedRefs$33(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$32(ownerName) : createSlotError$32(ownerName));
			return children;
		}
		const mergedProps = mergeProps$32(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$32 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$32 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function isSlottable$32(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$32;
}
var REACT_LAZY_TYPE$32 = Symbol.for("react.lazy");
function isLazyComponent$32(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$32 && "_payload" in element && isPromiseLike$32(element._payload);
}
function isPromiseLike$32(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$32 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$32 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$32 = import_react[" use ".trim().toString()];
//#endregion
...
function createCollection(name) {
	...
	const CollectionSlotImpl = /* @__PURE__ */ createSlot$32(COLLECTION_SLOT_NAME);
	const CollectionSlot = import_react.forwardRef((props, forwardedRef) => {
		const { scope, children } = props;
		const composedRefs = useComposedRefs$33(forwardedRef, useCollectionContext(COLLECTION_SLOT_NAME, scope).collectionRef);
	...
	const CollectionItemSlotImpl = /* @__PURE__ */ createSlot$32(ITEM_SLOT_NAME);
	const CollectionItemSlot = import_react.forwardRef((props, forwardedRef) => {
		const { scope, children, ...itemData } = props;
		const ref = import_react.useRef(null);
		const composedRefs = useComposedRefs$33(forwardedRef, ref);
...
function createCollection2(name) {
	...
	const CollectionProviderImpl = (props) => {
		...
		const composeRefs = useComposedRefs$33(ref, setCollectionElement);
	...
	const CollectionItemSlot = import_react.forwardRef((props, forwardedRef) => {
		...
		const composedRefs = useComposedRefs$33(forwardedRef, ref, setElement);
...
function setRef$32(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
function composeRefs$32(...refs) {
	return (node) => {
		let hasCleanup = false;
		const cleanups = refs.map((ref) => {
			const cleanup = setRef$32(ref, node);
			if (!hasCleanup && typeof cleanup == "function") hasCleanup = true;
			return cleanup;
		});
		if (hasCleanup) return () => {
			for (let i = 0; i < cleanups.length; i++) {
				const cleanup = cleanups[i];
				if (typeof cleanup == "function") cleanup();
				else setRef$32(refs[i], null);
			}
		};
	};
}
function useComposedRefs$32(...refs) {
	return import_react.useCallback(composeRefs$32(...refs), refs);
}
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$25(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
...
//#endregion
//#region ../../node_modules/@radix-ui/react-accordion/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$24 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-accordion/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$20 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$24;
function useControllableState$20({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$20({
		defaultProp,
		onChange
	});
...
function useUncontrolledState$20({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
	useInsertionEffect$20(() => {
...
// @__NO_SIDE_EFFECTS__
function createSlot$31(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$31(children) && typeof use$31 === "function") children = use$31(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$31(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$31(child) && typeof use$31 === "function") child = use$31(child._payload);
				slottableElement = getSlottableElementFromSlottable$31(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$31(slottableElement) : void 0;
		const composedRef = useComposedRefs$32(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$31(ownerName) : createSlotError$31(ownerName));
			return children;
		}
		const mergedProps = mergeProps$31(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$31 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$31 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$31(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$31(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$31(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$31;
}
var REACT_LAZY_TYPE$31 = Symbol.for("react.lazy");
function isLazyComponent$31(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$31 && "_payload" in element && isPromiseLike$31(element._payload);
}
function isPromiseLike$31(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$31 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$31 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$31 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$31 = [
	...
	const Slot = /* @__PURE__ */ createSlot$31(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$24(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
//#endregion
//#region ../../node_modules/@radix-ui/react-collapsible/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$23 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-collapsible/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$19 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$23;
function useControllableState$19({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$19({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$24(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$19({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
	useInsertionEffect$19(() => {
		onChangeRef.current = onChange;
	}, [onChange]);
	import_react.useEffect(() => {
		if (prevValueRef.current !== value) {
...
function setRef$31(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
function composeRefs$31(...refs) {
	return (node) => {
		let hasCleanup = false;
		const cleanups = refs.map((ref) => {
			const cleanup = setRef$31(ref, node);
			if (!hasCleanup && typeof cleanup == "function") hasCleanup = true;
			return cleanup;
		});
		if (hasCleanup) return () => {
			for (let i = 0; i < cleanups.length; i++) {
				const cleanup = cleanups[i];
				if (typeof cleanup == "function") cleanup();
				else setRef$31(refs[i], null);
			}
		};
	};
}
function useComposedRefs$31(...refs) {
	return import_react.useCallback(composeRefs$31(...refs), refs);
}
//#endregion
//#region ../../node_modules/@radix-ui/react-collapsible/node_modules/@radix-ui/react-slot/dist/index.mjs
// @__NO_SIDE_EFFECTS__
function createSlot$30(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$30(children) && typeof use$30 === "function") children = use$30(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$30(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$30(child) && typeof use$30 === "function") child = use$30(child._payload);
				slottableElement = getSlottableElementFromSlottable$30(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$30(slottableElement) : void 0;
		const composedRef = useComposedRefs$31(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$30(ownerName) : createSlotError$30(ownerName));
			return children;
		}
		const mergedProps = mergeProps$30(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$30 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$30 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$30(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$30(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$30(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$30;
}
var REACT_LAZY_TYPE$30 = Symbol.for("react.lazy");
function isLazyComponent$30(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$30 && "_payload" in element && isPromiseLike$30(element._payload);
}
function isPromiseLike$30(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$30 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$30 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$30 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$30 = [
	...
	const Slot = /* @__PURE__ */ createSlot$30(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var Collapsible = import_react.forwardRef((props, forwardedRef) => {
	...
	const [open, setOpen] = useControllableState$19({
		prop: openProp,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CollapsibleProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$30.div, {
...
var CollapsibleTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$30.button, {
		type: "button",
		...
		...triggerProps,
		ref: forwardedRef,
		onClick: composeEventHandlers$24(props.onClick, context.onOpenToggle)
	});
});
...
var CollapsibleContentImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$31(forwardedRef, ref);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$30.div, {
		"data-state": getState$5(context.open),
		"data-disabled": context.disabled ? "" : void 0,
...
var AccordionImplSingle = import_react.forwardRef((props, forwardedRef) => {
	...
	const [value, setValue] = useControllableState$20({
		prop: valueProp,
...
var AccordionImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$32(import_react.useRef(null), forwardedRef);
	const getItems = useCollection$8(__scopeAccordion);
	const isDirectionLTR = useDirection(dir) === "ltr";
	const handleKeyDown = composeEventHandlers$25(props.onKeyDown, (event) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AccordionImplProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$8.Slot, {
			scope: __scopeAccordion,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$31.div, {
				...accordionProps,
...
var AccordionHeader = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$31.h3, {
		"data-orientation": accordionContext.orientation,
...
function setRef$30(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
function composeRefs$30(...refs) {
	return (node) => {
		let hasCleanup = false;
		const cleanups = refs.map((ref) => {
			const cleanup = setRef$30(ref, node);
			if (!hasCleanup && typeof cleanup == "function") hasCleanup = true;
			return cleanup;
		});
		if (hasCleanup) return () => {
			for (let i = 0; i < cleanups.length; i++) {
				const cleanup = cleanups[i];
				if (typeof cleanup == "function") cleanup();
				else setRef$30(refs[i], null);
			}
		};
	};
}
function useComposedRefs$30(...refs) {
	return import_react.useCallback(composeRefs$30(...refs), refs);
}
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$23(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
var AlertDialogContent = import_react.forwardRef((props, forwardedRef) => {
	...
	const dialogScope = useDialogScope(__scopeAlertDialog);
	const composedRefs = useComposedRefs$30(forwardedRef, import_react.useRef(null));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogContentProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContent, {
			...
			...contentProps,
			ref: composedRefs,
			onOpenAutoFocus: composeEventHandlers$23(contentProps.onOpenAutoFocus, (event) => {
				event.preventDefault();
...
var AlertDialogCancel = import_react.forwardRef((props, forwardedRef) => {
	...
	const dialogScope = useDialogScope(__scopeAlertDialog);
	const ref = useComposedRefs$30(forwardedRef, cancelRef);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogClose, {
		...dialogScope,
		...cancelProps,
		ref
...
//#endregion
//#region ../../node_modules/@radix-ui/react-aspect-ratio/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
function setRef$29(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
function composeRefs$29(...refs) {
	return (node) => {
		let hasCleanup = false;
		const cleanups = refs.map((ref) => {
			const cleanup = setRef$29(ref, node);
			if (!hasCleanup && typeof cleanup == "function") hasCleanup = true;
			return cleanup;
		});
		if (hasCleanup) return () => {
			for (let i = 0; i < cleanups.length; i++) {
				const cleanup = cleanups[i];
				if (typeof cleanup == "function") cleanup();
				else setRef$29(refs[i], null);
			}
		};
	};
}
function useComposedRefs$29(...refs) {
	return import_react.useCallback(composeRefs$29(...refs), refs);
}
//#endregion
//#region ../../node_modules/@radix-ui/react-aspect-ratio/node_modules/@radix-ui/react-slot/dist/index.mjs
// @__NO_SIDE_EFFECTS__
function createSlot$29(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$29(children) && typeof use$29 === "function") children = use$29(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$29(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$29(child) && typeof use$29 === "function") child = use$29(child._payload);
				slottableElement = getSlottableElementFromSlottable$29(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$29(slottableElement) : void 0;
		const composedRef = useComposedRefs$29(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$29(ownerName) : createSlotError$29(ownerName));
			return children;
		}
		const mergedProps = mergeProps$29(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$29 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$29 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$29(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$29(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$29(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$29;
}
var REACT_LAZY_TYPE$29 = Symbol.for("react.lazy");
function isLazyComponent$29(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$29 && "_payload" in element && isPromiseLike$29(element._payload);
}
function isPromiseLike$29(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$29 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$29 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$29 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$29 = [
	...
	const Slot = /* @__PURE__ */ createSlot$29(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var AspectRatio = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$29.div, {
			...aspectRatioProps,
			ref: forwardedRef,
			style: {
				...style,
...
//#endregion
//#region ../../node_modules/@radix-ui/react-avatar/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$22 = globalThis?.document ? import_react.useLayoutEffect : () => {};
//#endregion
//#region ../../node_modules/@radix-ui/react-avatar/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
function setRef$28(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
function composeRefs$28(...refs) {
	return (node) => {
		let hasCleanup = false;
		const cleanups = refs.map((ref) => {
...
function useComposedRefs$28(...refs) {
	return import_react.useCallback(composeRefs$28(...refs), refs);
}
//#endregion
//#region ../../node_modules/@radix-ui/react-avatar/node_modules/@radix-ui/react-slot/dist/index.mjs
// @__NO_SIDE_EFFECTS__
function createSlot$28(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$28(children) && typeof use$28 === "function") children = use$28(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$28(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$28(child) && typeof use$28 === "function") child = use$28(child._payload);
				slottableElement = getSlottableElementFromSlottable$28(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$28(slottableElement) : void 0;
		const composedRef = useComposedRefs$28(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$28(ownerName) : createSlotError$28(ownerName));
			return children;
		}
		const mergedProps = mergeProps$28(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$28 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$28 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$28(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$28(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$28(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$28;
}
var REACT_LAZY_TYPE$28 = Symbol.for("react.lazy");
function isLazyComponent$28(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$28 && "_payload" in element && isPromiseLike$28(element._payload);
}
function isPromiseLike$28(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$28 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$28 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$28 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$28 = [
	...
	const Slot = /* @__PURE__ */ createSlot$28(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var Avatar = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarProvider, {
		...
		imageCount,
		setImageCount,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$28.span, {
			...avatarProps,
			ref: forwardedRef
		})
	});
...
var AvatarImage = import_react.forwardRef((props, forwardedRef) => {
	...
	return imageLoadingStatus === "loaded" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$28.img, {
		...imageProps,
		ref: forwardedRef,
		src
	}) : null;
...
var AvatarFallback = import_react.forwardRef((props, forwardedRef) => {
	...
	return canRender && context.imageLoadingStatus !== "loaded" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$28.span, {
		...fallbackProps,
		ref: forwardedRef
	}) : null;
});
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$22(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
//#endregion
//#region ../../node_modules/@radix-ui/react-checkbox/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$21 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-checkbox/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$18 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$21;
function useControllableState$18({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$18({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
...
function useUncontrolledState$18({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
var useLayoutEffect2$20 = globalThis?.document ? import_react.useLayoutEffect : () => {};
//#endregion
...
//#endregion
//#region ../../node_modules/@radix-ui/react-checkbox/node_modules/@radix-ui/react-slot/dist/index.mjs
// @__NO_SIDE_EFFECTS__
function createSlot$27(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$27(children) && typeof use$27 === "function") children = use$27(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$27(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$27(child) && typeof use$27 === "function") child = use$27(child._payload);
				slottableElement = getSlottableElementFromSlottable$27(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$27(slottableElement) : void 0;
		const composedRef = useComposedRefs$27(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$27(ownerName) : createSlotError$27(ownerName));
			return children;
		}
		const mergedProps = mergeProps$27(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$27 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$27 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$27(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$27(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$27(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$27;
}
var REACT_LAZY_TYPE$27 = Symbol.for("react.lazy");
function isLazyComponent$27(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$27 && "_payload" in element && isPromiseLike$27(element._payload);
}
function isPromiseLike$27(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$27 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$27 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$27 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$27 = [
	...
	const Slot = /* @__PURE__ */ createSlot$27(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
function CheckboxProvider(props) {
	...
	const [checked, setChecked] = useControllableState$18({
		prop: checkedProp,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CheckboxProviderImpl, {
		...
		...context,
		children: isFunction$22(internal_do_not_use_render) ? internal_do_not_use_render(context) : children
	});
}
...
var CheckboxTrigger = import_react.forwardRef(({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$27(forwardedRef, setControl);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$27.button, {
		type: "button",
		role: "checkbox",
		...
		...checkboxProps,
		ref: composedRefs,
		onKeyDown: composeEventHandlers$22(onKeyDown, (event) => {
			if (event.key === "Enter") event.preventDefault();
		}),
		onClick: composeEventHandlers$22(onClick, (event) => {
...
var CheckboxIndicator = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$27.span, {
...
var CheckboxBubbleInput = import_react.forwardRef(({ __scopeCheckbox, ...props }, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$27(forwardedRef, setBubbleInput);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$27.input, {
		type: "checkbox",
		"aria-hidden": true,
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$21(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
//#endregion
//#region ../../node_modules/@radix-ui/react-context-menu/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
// @__NO_SIDE_EFFECTS__
function createSlot$26(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$26(children) && typeof use$26 === "function") children = use$26(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$26(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$26(child) && typeof use$26 === "function") child = use$26(child._payload);
				slottableElement = getSlottableElementFromSlottable$26(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$26(slottableElement) : void 0;
		const composedRef = useComposedRefs$26(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$26(ownerName) : createSlotError$26(ownerName));
			return children;
		}
		const mergedProps = mergeProps$26(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$26 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$26 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$26(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$26(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$26(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$26;
}
var REACT_LAZY_TYPE$26 = Symbol.for("react.lazy");
function isLazyComponent$26(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$26 && "_payload" in element && isPromiseLike$26(element._payload);
}
function isPromiseLike$26(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$26 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$26 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$26 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$26 = [
	...
	const Slot = /* @__PURE__ */ createSlot$26(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$20(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
// @__NO_SIDE_EFFECTS__
function createSlot$25(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$25(children) && typeof use$25 === "function") children = use$25(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$25(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$25(child) && typeof use$25 === "function") child = use$25(child._payload);
				slottableElement = getSlottableElementFromSlottable$25(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$25(slottableElement) : void 0;
		const composedRef = useComposedRefs$24(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$25(ownerName) : createSlotError$25(ownerName));
			return children;
		}
		const mergedProps = mergeProps$25(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$25 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$25 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$25(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$25(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$25(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$25;
}
var REACT_LAZY_TYPE$25 = Symbol.for("react.lazy");
function isLazyComponent$25(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$25 && "_payload" in element && isPromiseLike$25(element._payload);
}
function isPromiseLike$25(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$25 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$25 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$25 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$25 = [
	...
	const Slot = /* @__PURE__ */ createSlot$25(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var Arrow$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$25.svg, {
		...arrowProps,
		ref: forwardedRef,
		width,
		height,
...
// @__NO_SIDE_EFFECTS__
function createSlot$24(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$24(children) && typeof use$24 === "function") children = use$24(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$24(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$24(child) && typeof use$24 === "function") child = use$24(child._payload);
				slottableElement = getSlottableElementFromSlottable$24(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$24(slottableElement) : void 0;
		const composedRef = useComposedRefs$23(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$24(ownerName) : createSlotError$24(ownerName));
			return children;
		}
		const mergedProps = mergeProps$24(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$24 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$24 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$24(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$24(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$24(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$24;
}
var REACT_LAZY_TYPE$24 = Symbol.for("react.lazy");
function isLazyComponent$24(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$24 && "_payload" in element && isPromiseLike$24(element._payload);
}
function isPromiseLike$24(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$24 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$24 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$24 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$24 = [
	...
	const Slot = /* @__PURE__ */ createSlot$24(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var useLayoutEffect2$19 = globalThis?.document ? import_react.useLayoutEffect : () => {};
//#endregion
...
var PopperAnchor = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$23(forwardedRef, import_react.useCallback((node) => {
		ref.current = node;
	...
	return virtualRef ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$24.div, {
...
var PopperContent = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$23(forwardedRef, setContent);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopperContentProvider, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$24.div, {
...
// @__NO_SIDE_EFFECTS__
function createSlot$23(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		let { children, ...slotProps } = props;
		let slottableElement = null;
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$23(children) && typeof use$23 === "function") children = use$23(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$23(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$23(child) && typeof use$23 === "function") child = use$23(child._payload);
				slottableElement = getSlottableElementFromSlottable$23(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$23(slottableElement) : void 0;
		const composedRef = useComposedRefs$25(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$23(ownerName) : createSlotError$23(ownerName));
			return children;
		}
		const mergedProps = mergeProps$23(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$23 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$23 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function mergeProps$23(slotProps, childProps) {
	const overrideProps = { ...childProps };
	for (const propName in childProps) {
		const slotPropValue = slotProps[propName];
		const childPropValue = childProps[propName];
...
function getElementRef$23(element) {
	let getter = Object.getOwnPropertyDescriptor(element.props, "ref")?.get;
	let mayWarn = getter && "isReactWarning" in getter && getter.isReactWarning;
	if (mayWarn) return element.ref;
	getter = Object.getOwnPropertyDescriptor(element, "ref")?.get;
...
function isSlottable$23(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$23;
}
var REACT_LAZY_TYPE$23 = Symbol.for("react.lazy");
function isLazyComponent$23(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$23 && "_payload" in element && isPromiseLike$23(element._payload);
}
function isPromiseLike$23(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$23 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$23 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$23 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$23 = [
	...
	const Slot = /* @__PURE__ */ createSlot$23(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$19(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
function createSlot$22(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$22(children) && typeof use$22 === "function") children = use$22(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$22(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$22(child) && typeof use$22 === "function") child = use$22(child._payload);
				slottableElement = getSlottableElementFromSlottable$22(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$22(slottableElement) : void 0;
		const composedRef = useComposedRefs$22(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$22(ownerName) : createSlotError$22(ownerName));
			return children;
		}
		const mergedProps = mergeProps$22(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$22 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$22 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$22 = Symbol.for("react.lazy");
function isLazyComponent$22(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$22 && "_payload" in element && isPromiseLike$22(element._payload);
}
function isPromiseLike$22(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$22 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$22 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$22 = import_react[" use ".trim().toString()];
//#endregion
...
var Primitive$22 = [
	...
	const Slot = /* @__PURE__ */ createSlot$22(`Primitive.${node}`);
	const Node = import_react.forwardRef((props, forwardedRef) => {
		const { asChild, ...primitiveProps } = props;
		const Comp = asChild ? Slot : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
//#endregion
//#region ../../node_modules/@radix-ui/react-roving-focus/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$18 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-roving-focus/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$17 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$18;
function useControllableState$17({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$17({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$21(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$17({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
var RovingFocusGroupImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$22(forwardedRef, ref);
	const direction = useDirection(dir);
	const [currentTabStopId, setCurrentTabStopId] = useControllableState$17({
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RovingFocusProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$22.div, {
			...
			onMouseDown: composeEventHandlers$19(props.onMouseDown, () => {
				isClickFocusRef.current = true;
			}),
			onFocus: composeEventHandlers$19(props.onFocus, (event) => {
			...
			onBlur: composeEventHandlers$19(props.onBlur, () => setIsTabbingBackOut(false))
		})
	});
});
...
var RovingFocusGroupItem = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$7.ItemSlot, {
		...
		focusable,
		active,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$22.span, {
			tabIndex: isCurrentTabStop ? 0 : -1,
			"data-orientation": context.orientation,
			...itemProps,
			ref: forwardedRef,
			onMouseDown: composeEventHandlers$19(props.onMouseDown, (event) => {
				if (!focusable) event.preventDefault();
				else context.onItemFocus(id);
			}),
			onFocus: composeEventHandlers$19(props.onFocus, () => context.onItemFocus(id)),
			onKeyDown: composeEventHandlers$19(props.onKeyDown, (event) => {
...
var MenuRootContentModal = import_react.forwardRef((props, forwardedRef) => {
	const context = useMenuContext(CONTENT_NAME$9, props.__scopeMenu);
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$25(forwardedRef, ref);
	import_react.useEffect(() => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuContentImpl, {
		...
		onFocusOutside: composeEventHandlers$20(props.onFocusOutside, (event) => event.preventDefault(), { checkForDefaultPrevented: false }),
...
var Slot$3 = /* @__PURE__ */ createSlot$23("MenuContent.ScrollLock");
var MenuContentImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$25(forwardedRef, contentRef, context.onContentChange);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuContentProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollLockWrapper, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusScope, {
				asChild: true,
				trapped: trapFocus,
				onMountAutoFocus: composeEventHandlers$20(onOpenAutoFocus, (event) => {
					event.preventDefault();
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DismissableLayer, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$7, {
						...
						onEntryFocus: composeEventHandlers$20(onEntryFocus, (event) => {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content$2, {
							...
							onKeyDown: composeEventHandlers$20(contentProps.onKeyDown, (event) => {
							...
							onBlur: composeEventHandlers$20(props.onBlur, (event) => {
								if (!event.currentTarget.contains(event.target)) {
									window.clearTimeout(timerRef.current);
									searchRef.current = "";
								}
							}),
							onPointerMove: composeEventHandlers$20(props.onPointerMove, whenMouse$1((event) => {
								const target = event.target;
...
var MenuGroup = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$23.div, {
		role: "group",
		...groupProps,
		ref: forwardedRef
	});
...
var MenuItem = import_react.forwardRef((props, forwardedRef) => {
	...
	const handleSelect = () => {
		...
		if (!disabled && menuItem) {
			...
			dispatchDiscreteCustomEvent$2(menuItem, itemSelectEvent);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuItemImpl, {
		...
		ref: composedRefs,
		disabled,
		onClick: composeEventHandlers$20(props.onClick, handleSelect),
		onPointerDown: (event) => {
			props.onPointerDown?.(event);
			isPointerDownRef.current = true;
		},
		onPointerUp: composeEventHandlers$20(props.onPointerUp, (event) => {
			if (!isPointerDownRef.current) event.currentTarget?.click();
		}),
		onKeyDown: composeEventHandlers$20(props.onKeyDown, (event) => {
...
var MenuItemImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$6.ItemSlot, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item$1, {
			...
			...rovingFocusGroupScope,
			focusable: !disabled,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$23.div, {
				role: "menuitem",
				...
				onPointerLeave: composeEventHandlers$20(props.onPointerLeave, whenMouse$1((event) => contentContext.onItemLeave(event))),
				onFocus: composeEventHandlers$20(props.onFocus, () => setIsFocused(true)),
				onBlur: composeEventHandlers$20(props.onBlur, () => setIsFocused(false))
			})
		})
	});
});
...
var MenuCheckboxItem = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ItemIndicatorProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuItem, {
			...
			onSelect: composeEventHandlers$20(checkboxItemProps.onSelect, () => onCheckedChange?.(isIndeterminate(checked) ? true : !checked), { checkForDefaultPrevented: false })
		})
	});
});
...
var MenuRadioItem = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ItemIndicatorProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuItem, {
			...
			ref: forwardedRef,
			"data-state": getCheckedState(checked),
			onSelect: composeEventHandlers$20(radioItemProps.onSelect, () => context.onValueChange?.(value), { checkForDefaultPrevented: false })
		})
	});
});
...
var MenuItemIndicator = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$23.span, {
			...itemIndicatorProps,
			ref: forwardedRef,
...
var MenuSubTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$25(forwardedRef, subContext.onTriggerChange);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuAnchor, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuItemImpl, {
			...
			onPointerLeave: composeEventHandlers$20(props.onPointerLeave, whenMouse$1((event) => {
				clearOpenTimer();
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$6.Slot, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MenuContentImpl, {
					...
					onFocusOutside: composeEventHandlers$20(props.onFocusOutside, (event) => {
						if (event.target !== subContext.trigger) context.onOpenChange(false);
					}),
					onEscapeKeyDown: composeEventHandlers$20(props.onEscapeKeyDown, (event) => {
						rootContext.onClose();
						event.preventDefault();
					}),
					onKeyDown: composeEventHandlers$20(props.onKeyDown, (event) => {
...
//#endregion
//#region ../../node_modules/@radix-ui/react-context-menu/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$17 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-context-menu/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$16 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$17;
function useControllableState$16({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$16({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
...
function useUncontrolledState$16({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
	useInsertionEffect$16(() => {
		onChangeRef.current = onChange;
	}, [onChange]);
	import_react.useEffect(() => {
		if (prevValueRef.current !== value) {
...
var ContextMenu = (props) => {
	...
	const [open, setOpen] = useControllableState$16({
		prop: openProp,
		defaultProp: false,
		onChange: onOpenChange,
...
var ContextMenuTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Anchor2$1, {
		...menuScope,
		virtualRef
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$26.span, {
		...
		onContextMenu: disabled ? props.onContextMenu : composeEventHandlers$21(props.onContextMenu, (event) => {
			clearLongPress();
			handleOpen(event);
			event.preventDefault();
		}),
		onPointerDown: disabled ? props.onPointerDown : composeEventHandlers$21(props.onPointerDown, whenTouchOrPen((event) => {
			clearLongPress();
			if (context.open) context.onOpenChange(false);
			longPressTimerRef.current = window.setTimeout(() => handleOpen(event), 700);
		})),
		onPointerMove: disabled ? props.onPointerMove : composeEventHandlers$21(props.onPointerMove, whenTouchOrPen(clearLongPress)),
		onPointerCancel: disabled ? props.onPointerCancel : composeEventHandlers$21(props.onPointerCancel, whenTouchOrPen(clearLongPress)),
		onPointerUp: disabled ? props.onPointerUp : composeEventHandlers$21(props.onPointerUp, whenTouchOrPen(clearLongPress))
	})] });
});
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$18(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
var useLayoutEffect2$16 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-dropdown-menu/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$15 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$16;
function useControllableState$15({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$15({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
...
function useUncontrolledState$15({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
function createSlot$21(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$21(children) && typeof use$21 === "function") children = use$21(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$21(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$21(child) && typeof use$21 === "function") child = use$21(child._payload);
				slottableElement = getSlottableElementFromSlottable$21(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$21(slottableElement) : void 0;
		const composedRef = useComposedRefs$21(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$21(ownerName) : createSlotError$21(ownerName));
			return children;
		}
		const mergedProps = mergeProps$21(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$21 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$21 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$21 = Symbol.for("react.lazy");
function isLazyComponent$21(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$21 && "_payload" in element && isPromiseLike$21(element._payload);
}
function isPromiseLike$21(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$21 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$21 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$21 = import_react[" use ".trim().toString()];
//#endregion
...
var DropdownMenu = (props) => {
	...
	const [open, setOpen] = useControllableState$15({
		prop: openProp,
		defaultProp: defaultOpen ?? false,
		onChange: onOpenChange,
...
var DropdownMenuTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	const menuScope = useMenuScope$1(__scopeDropdownMenu);
	const composedRefs = useComposedRefs$21(forwardedRef, context.triggerRef);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Anchor2$1, {
		asChild: true,
		...menuScope,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$21.button, {
			type: "button",
			...
			...triggerProps,
			ref: composedRefs,
			onPointerDown: composeEventHandlers$18(props.onPointerDown, (event) => {
				if (!disabled && event.button === 0 && event.ctrlKey === false) {
					context.onOpenToggle();
					if (!context.open) event.preventDefault();
				}
			}),
			onKeyDown: composeEventHandlers$18(props.onKeyDown, (event) => {
				if (disabled) return;
...
var DropdownMenuContent = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2$6, {
		...
		...contentProps,
		ref: forwardedRef,
		onCloseAutoFocus: composeEventHandlers$18(props.onCloseAutoFocus, (event) => {
			if (!hasInteractedOutsideRef.current) context.triggerRef.current?.focus();
			hasInteractedOutsideRef.current = false;
			event.preventDefault();
		}),
		onInteractOutside: composeEventHandlers$18(props.onInteractOutside, (event) => {
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$17(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
function createSlot$20(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$20(children) && typeof use$20 === "function") children = use$20(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$20(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$20(child) && typeof use$20 === "function") child = use$20(child._payload);
				slottableElement = getSlottableElementFromSlottable$20(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$20(slottableElement) : void 0;
		const composedRef = useComposedRefs$19(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$20(ownerName) : createSlotError$20(ownerName));
			return children;
		}
		const mergedProps = mergeProps$20(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$20 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$20 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
function isSlottable$20(child) {
	return import_react.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$20;
}
var REACT_LAZY_TYPE$20 = Symbol.for("react.lazy");
function isLazyComponent$20(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$20 && "_payload" in element && isPromiseLike$20(element._payload);
}
function isPromiseLike$20(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$20 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$20 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$20 = import_react[" use ".trim().toString()];
//#endregion
...
var Label$1 = import_react.forwardRef((props, forwardedRef) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$20.label, {
		...props,
		ref: forwardedRef,
		onMouseDown: (event) => {
...
function createSlot$19(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$19(children) && typeof use$19 === "function") children = use$19(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$19(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$19(child) && typeof use$19 === "function") child = use$19(child._payload);
				slottableElement = getSlottableElementFromSlottable$19(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$19(slottableElement) : void 0;
		const composedRef = useComposedRefs$20(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$19(ownerName) : createSlotError$19(ownerName));
			return children;
		}
		const mergedProps = mergeProps$19(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$19 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$19 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$19 = Symbol.for("react.lazy");
function isLazyComponent$19(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$19 && "_payload" in element && isPromiseLike$19(element._payload);
}
function isPromiseLike$19(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$19 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$19 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$19 = import_react[" use ".trim().toString()];
//#endregion
...
var Form = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedFormRef = useComposedRefs$20(forwardedRef, import_react.useRef(null));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ValidationProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AriaDescriptionProvider, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$19.form, {
				...rootProps,
				ref: composedFormRef,
				onInvalid: composeEventHandlers$17(props.onInvalid, (event) => {
					const firstInvalidControl = getFirstInvalidControl(event.currentTarget);
					if (firstInvalidControl === event.target) firstInvalidControl.focus();
					event.preventDefault();
				}),
				onSubmit: composeEventHandlers$17(props.onSubmit, onClearServerErrors, { checkForDefaultPrevented: false }),
				onReset: composeEventHandlers$17(props.onReset, onClearServerErrors)
			})
		})
	});
});
...
var FormControl = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRef = useComposedRefs$20(forwardedRef, ref);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$19.input, {
		"data-valid": getValidAttribute(validity, fieldContext.serverInvalid),
		"data-invalid": getInvalidAttribute(validity, fieldContext.serverInvalid),
		...
		onChange: composeEventHandlers$17(props.onChange, (_event) => {
			resetControlValidity();
		})
	});
});
...
var FormCustomMessage = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRef = useComposedRefs$20(forwardedRef, import_react.useRef(null));
	const _id = useId();
	const id = idProp ?? _id;
...
var FormMessageImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$19.span, {
		id,
		...messageProps,
		ref: forwardedRef
	});
...
var FormSubmit = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$19.button, {
		type: "submit",
		...submitProps,
		ref: forwardedRef
	});
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$16(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
//#endregion
//#region ../../node_modules/@radix-ui/react-hover-card/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$15 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-hover-card/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$14 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$15;
function useControllableState$14({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$14({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$18(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$14({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
function createSlot$18(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$18(children) && typeof use$18 === "function") children = use$18(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$18(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$18(child) && typeof use$18 === "function") child = use$18(child._payload);
				slottableElement = getSlottableElementFromSlottable$18(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$18(slottableElement) : void 0;
		const composedRef = useComposedRefs$18(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$18(ownerName) : createSlotError$18(ownerName));
			return children;
		}
		const mergedProps = mergeProps$18(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$18 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$18 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$18 = Symbol.for("react.lazy");
function isLazyComponent$18(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$18 && "_payload" in element && isPromiseLike$18(element._payload);
}
function isPromiseLike$18(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$18 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$18 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$18 = import_react[" use ".trim().toString()];
//#endregion
...
var HoverCard = (props) => {
	...
	const [open, setOpen] = useControllableState$14({
		prop: openProp,
		defaultProp: defaultOpen ?? false,
		onChange: onOpenChange,
...
var HoverCardTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Anchor, {
		asChild: true,
		...popperScope,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$18.a, {
			"data-state": context.open ? "open" : "closed",
			...triggerProps,
			ref: forwardedRef,
			onPointerEnter: composeEventHandlers$16(props.onPointerEnter, excludeTouch(context.onOpen)),
			onPointerLeave: composeEventHandlers$16(props.onPointerLeave, excludeTouch(context.onClose)),
			onFocus: composeEventHandlers$16(props.onFocus, context.onOpen),
			onBlur: composeEventHandlers$16(props.onBlur, context.onClose),
			onTouchStart: composeEventHandlers$16(props.onTouchStart, (event) => event.preventDefault())
		})
	});
});
...
var HoverCardContentImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DismissableLayer, {
		...
		onEscapeKeyDown,
		onPointerDownOutside,
		onFocusOutside: composeEventHandlers$16(onFocusOutside, (event) => {
			event.preventDefault();
		}),
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content$2, {
			...popperScope,
			...contentProps,
			onPointerDown: composeEventHandlers$16(contentProps.onPointerDown, (event) => {
...
typeof window !== "undefined" && window.document && window.document.createElement;
function composeEventHandlers$15(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
	return function handleEvent(event) {
		originalEventHandler?.(event);
		if (checkForDefaultPrevented === false || !event.defaultPrevented) return ourEventHandler?.(event);
	};
...
function createSlot$17(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$17(children) && typeof use$17 === "function") children = use$17(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$17(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$17(child) && typeof use$17 === "function") child = use$17(child._payload);
				slottableElement = getSlottableElementFromSlottable$17(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$17(slottableElement) : void 0;
		const composedRef = useComposedRefs$17(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$17(ownerName) : createSlotError$17(ownerName));
			return children;
		}
		const mergedProps = mergeProps$17(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$17 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$17 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$17 = Symbol.for("react.lazy");
function isLazyComponent$17(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$17 && "_payload" in element && isPromiseLike$17(element._payload);
}
function isPromiseLike$17(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$17 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$17 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$17 = import_react[" use ".trim().toString()];
//#endregion
...
//#endregion
//#region ../../node_modules/@radix-ui/react-menubar/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$14 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-menubar/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$13 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$14;
function useControllableState$13({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$13({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$17(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$13({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
var Menubar = import_react.forwardRef((props, forwardedRef) => {
	...
	const [value, setValue] = useControllableState$13({
		prop: valueProp,
		onChange: onValueChange,
		defaultProp: defaultValue ?? "",
		caller: MENUBAR_NAME
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$5.Provider, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$5.Slot, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$7, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$17.div, {
						role: "menubar",
						...menubarProps,
						ref: forwardedRef
					})
...
var MenubarTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$17(forwardedRef, ref, menuContext.triggerRef);
	const [isFocused, setIsFocused] = import_react.useState(false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$5.ItemSlot, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item$1, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Anchor2$1, {
				asChild: true,
				...menuScope,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$17.button, {
					type: "button",
					role: "menuitem",
					...
					...triggerProps,
					ref: composedRefs,
					onPointerDown: composeEventHandlers$15(props.onPointerDown, (event) => {
						if (!disabled && event.button === 0 && event.ctrlKey === false) {
							context.onMenuOpen(menuContext.value);
							if (!open) event.preventDefault();
						}
					}),
					onPointerEnter: composeEventHandlers$15(props.onPointerEnter, () => {
						if (Boolean(context.value) && !open) {
							context.onMenuOpen(menuContext.value);
							ref.current?.focus();
						}
					}),
					onKeyDown: composeEventHandlers$15(props.onKeyDown, (event) => {
						if (disabled) return;
					...
					onFocus: composeEventHandlers$15(props.onFocus, () => setIsFocused(true)),
					onBlur: composeEventHandlers$15(props.onBlur, () => setIsFocused(false))
				})
			})
		})
	});
...
var MenubarContent = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2$6, {
		...
		ref: forwardedRef,
		align,
		onCloseAutoFocus: composeEventHandlers$15(props.onCloseAutoFocus, (event) => {
			if (!Boolean(context.value) && !hasInteractedOutsideRef.current) menuContext.triggerRef.current?.focus();
			hasInteractedOutsideRef.current = false;
			event.preventDefault();
		}),
		onFocusOutside: composeEventHandlers$15(props.onFocusOutside, (event) => {
			const target = event.target;
			if (getItems().some((item) => item.ref.current?.contains(target))) event.preventDefault();
		}),
		onInteractOutside: composeEventHandlers$15(props.onInteractOutside, () => {
...
var MenubarSub = (props) => {
	...
	const menuScope = useMenuScope(__scopeMenubar);
	const [open, setOpen] = useControllableState$13({
		prop: openProp,
		defaultProp: defaultOpen ?? false,
		onChange: onOpenChange,
		caller: SUB_NAME$1
...
function createSlot$16(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$16(children) && typeof use$16 === "function") children = use$16(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$16(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$16(child) && typeof use$16 === "function") child = use$16(child._payload);
				slottableElement = getSlottableElementFromSlottable$16(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$16(slottableElement) : void 0;
		const composedRef = useComposedRefs$16(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$16(ownerName) : createSlotError$16(ownerName));
			return children;
		}
		const mergedProps = mergeProps$16(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$16 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$16 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$16 = Symbol.for("react.lazy");
function isLazyComponent$16(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$16 && "_payload" in element && isPromiseLike$16(element._payload);
}
function isPromiseLike$16(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$16 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$16 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$16 = import_react[" use ".trim().toString()];
//#endregion
...
//#endregion
//#region ../../node_modules/@radix-ui/react-navigation-menu/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$13 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-navigation-menu/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$12 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$13;
function useControllableState$12({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$12({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$16(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$12({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
	useInsertionEffect$12(() => {
		onChangeRef.current = onChange;
	}, [onChange]);
	import_react.useEffect(() => {
		if (prevValueRef.current !== value) {
...
var NavigationMenu = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRef = useComposedRefs$16(forwardedRef, setNavigationMenu);
	const direction = useDirection(dir);
	const openTimerRef = import_react.useRef(0);
	const closeTimerRef = import_react.useRef(0);
	const skipDelayTimerRef = import_react.useRef(0);
	const [isOpenDelayed, setIsOpenDelayed] = import_react.useState(true);
	const [value, setValue] = useControllableState$12({
		prop: valueProp,
		onChange: (value2) => {
			const isOpen = value2 !== "";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavigationMenuProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$16.nav, {
			"aria-label": "Main",
			"data-orientation": orientation,
			dir: direction,
			...NavigationMenuProps,
...
var NavigationMenuList = import_react.forwardRef((props, forwardedRef) => {
	...
	const list = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$16.ul, {
		"data-orientation": context.orientation,
		...listProps,
		ref: forwardedRef
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$16.div, {
...
var NavigationMenuItem = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavigationMenuItemContextProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$16.li, {
			...itemProps,
			ref: forwardedRef
		})
	});
...
var NavigationMenuTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$16(ref, itemContext.triggerRef, forwardedRef);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$4.ItemSlot, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusGroupItem, {
			asChild: true,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$16.button, {
				id: triggerId,
				disabled,
				"data-disabled": disabled ? "" : void 0,
				...
				...triggerProps,
				ref: composedRefs,
				onPointerEnter: composeEventHandlers$14(props.onPointerEnter, () => {
					wasClickCloseRef.current = false;
					itemContext.wasEscapeCloseRef.current = false;
				}),
				onPointerMove: composeEventHandlers$14(props.onPointerMove, whenMouse(() => {
				...
				onPointerLeave: composeEventHandlers$14(props.onPointerLeave, whenMouse(() => {
					if (disabled) return;
					context.onTriggerLeave();
					hasPointerMoveOpenedRef.current = false;
				})),
				onClick: composeEventHandlers$14(props.onClick, () => {
					context.onItemSelect(itemContext.value);
					wasClickCloseRef.current = open;
				}),
				onKeyDown: composeEventHandlers$14(props.onKeyDown, (event) => {
					const entryKey = {
...
var NavigationMenuLink = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusGroupItem, {
		asChild: true,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$16.a, {
			"data-active": active ? "" : void 0,
			"aria-current": active ? "page" : void 0,
			...linkProps,
			ref: forwardedRef,
			onClick: composeEventHandlers$14(props.onClick, (event) => {
				const target = event.target;
...
var NavigationMenuIndicatorImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return position ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$16.div, {
		"aria-hidden": true,
...
var NavigationMenuContent = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$16(itemContext.contentRef, forwardedRef);
	const open = itemContext.value === context.value;
	const commonProps = {
		value: itemContext.value,
	...
	return !context.viewport ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NavigationMenuContentImpl, {
			...
			...commonProps,
			ref: composedRefs,
			onPointerEnter: composeEventHandlers$14(props.onPointerEnter, context.onContentEnter),
			onPointerLeave: composeEventHandlers$14(props.onPointerLeave, whenMouse(context.onContentLeave)),
			style: {
...
var NavigationMenuContentImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$16(ref, forwardedRef);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusGroup, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DismissableLayer, {
			...
			onFocusOutside: composeEventHandlers$14(props.onFocusOutside, (event) => {
				onContentFocusOutside();
				const target = event.target;
				if (context.rootNavigationMenu?.contains(target)) event.preventDefault();
			}),
			onPointerDownOutside: composeEventHandlers$14(props.onPointerDownOutside, (event) => {
				const target = event.target;
			...
			onEscapeKeyDown: composeEventHandlers$14(props.onEscapeKeyDown, (_event) => {
...
var NavigationMenuViewportImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$16(forwardedRef, context.onViewportChange);
...
var NavigationMenuViewportItem = ({ contentRef, isActive, onActiveContentChange, ...props }) => {
	const composedRefs = useComposedRefs$16(contentRef, import_react.useCallback((node) => {
...
function createSlot$15(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$15(children) && typeof use$15 === "function") children = use$15(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$15(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$15(child) && typeof use$15 === "function") child = use$15(child._payload);
				slottableElement = getSlottableElementFromSlottable$15(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$15(slottableElement) : void 0;
		const composedRef = useComposedRefs$15(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$15(ownerName) : createSlotError$15(ownerName));
			return children;
		}
		const mergedProps = mergeProps$15(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$15 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$15 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$15 = Symbol.for("react.lazy");
function isLazyComponent$15(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$15 && "_payload" in element && isPromiseLike$15(element._payload);
}
function isPromiseLike$15(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$15 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$15 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$15 = import_react[" use ".trim().toString()];
var Root$4 = [
	"a",
	"button",
	"div",
...
//#endregion
//#region ../../node_modules/@radix-ui/react-one-time-password-field/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$12 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-one-time-password-field/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$11 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$12;
function useControllableState$11({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$11({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$15(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$11({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
var OneTimePasswordField = import_react.forwardRef(function OneTimePasswordFieldImpl({ __scopeOneTimePasswordField, defaultValue, value: valueProp, onValueChange, autoSubmit = false, children, onPaste, onAutoSubmit, disabled = false, readOnly = false, autoComplete = "one-time-code", autoFocus = false, form, name, placeholder, type = "text", orientation = "horizontal", dir, validationType = "numeric", sanitizeValue: sanitizeValueProp, ...domProps }, forwardedRef) {
	...
	const [value, setValue] = useControllableState$11({
	...
	const composedRefs = useComposedRefs$15(forwardedRef, rootRef);
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$3.Provider, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$3.Slot, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$7, {
					...
					orientation,
					dir: direction,
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$4.div, {
						...domProps,
						role: "group",
						ref: composedRefs,
						onPaste: composeEventHandlers$13(onPaste, (event) => {
							event.preventDefault();
...
var OneTimePasswordFieldHiddenInput = import_react.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		ref: useComposedRefs$15(hiddenInputRef, forwardedRef),
		name,
...
var OneTimePasswordFieldInput = import_react.forwardRef(function OneTimePasswordFieldInput2({ __scopeOneTimePasswordField, onInvalidChange, index: indexProp, ...props }, forwardedRef) {
	...
	const composedInputRef = useComposedRefs$15(forwardedRef, inputRef, setElement);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$3.ItemSlot, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item$1, {
			...
			children: ({ hasTabStop, isCurrentTabStop }) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$4.input, {
					...
					...domProps,
					onFocus: composeEventHandlers$13(props.onFocus, (event) => {
						event.currentTarget.select();
					}),
					onCut: composeEventHandlers$13(props.onCut, (event) => {
					...
					onInput: composeEventHandlers$13(props.onInput, (event) => {
					...
					onChange: composeEventHandlers$13(props.onChange, (event) => {
					...
					onKeyDown: composeEventHandlers$13(props.onKeyDown, (event) => {
						switch (event.key) {
							case "Clear":
							case "Delete":
							case "Backspace":
					...
					onPointerDown: composeEventHandlers$13(props.onPointerDown, (event) => {
						event.preventDefault();
...
//#endregion
//#region ../../node_modules/@radix-ui/react-password-toggle-field/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$11 = globalThis?.document ? import_react.useLayoutEffect : () => {};
//#endregion
//#region ../../node_modules/@radix-ui/react-password-toggle-field/node_modules/@radix-ui/react-use-effect-event/dist/index.mjs
var useReactEffectEvent$10 = import_react[" useEffectEvent ".trim().toString()];
var useReactInsertionEffect$10 = import_react[" useInsertionEffect ".trim().toString()];
function useEffectEvent(callback) {
	if (typeof useReactEffectEvent$10 === "function") return useReactEffectEvent$10(callback);
	const ref = import_react.useRef(() => {
		throw new Error("Cannot call an event handler while rendering.");
	});
	if (typeof useReactInsertionEffect$10 === "function") useReactInsertionEffect$10(() => {
		ref.current = callback;
	});
	else useLayoutEffect2$11(() => {
		ref.current = callback;
	});
	return import_react.useMemo(() => ((...args) => ref.current?.(...args)), []);
}
//#endregion
//#region ../../node_modules/@radix-ui/react-password-toggle-field/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$10 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$11;
function useControllableState$10({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$10({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$14(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$10({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
function createSlot$14(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$14(children) && typeof use$14 === "function") children = use$14(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$14(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$14(child) && typeof use$14 === "function") child = use$14(child._payload);
				slottableElement = getSlottableElementFromSlottable$14(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$14(slottableElement) : void 0;
		const composedRef = useComposedRefs$14(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$14(ownerName) : createSlotError$14(ownerName));
			return children;
		}
		const mergedProps = mergeProps$14(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$14 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$14 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$14 = Symbol.for("react.lazy");
function isLazyComponent$14(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$14 && "_payload" in element && isPromiseLike$14(element._payload);
}
function isPromiseLike$14(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$14 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$14 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$14 = import_react[" use ".trim().toString()];
//#endregion
...
var PasswordToggleField = ({ __scopePasswordToggleField, ...props }) => {
	...
	const [visible = false, setVisible] = useControllableState$10({
...
var PasswordToggleFieldInput = import_react.forwardRef(({ __scopePasswordToggleField, autoComplete = "current-password", autoCapitalize = "off", spellCheck = false, id: idProp, ...props }, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$14.input, {
		...props,
		id: idProp ?? inputId,
		autoCapitalize,
		autoComplete,
		ref: useComposedRefs$14(forwardedRef, inputRef),
		spellCheck,
		type: visible ? "text" : "password",
		onBlur: composeEventHandlers$12(props.onBlur, (event) => {
...
var PasswordToggleFieldToggle = import_react.forwardRef(({ __scopePasswordToggleField, onClick, onPointerDown, onPointerCancel, onPointerUp, onFocus, children, "aria-label": ariaLabelProp, "aria-controls": ariaControls, "aria-hidden": ariaHidden, tabIndex, ...props }, forwardedRef) => {
	...
	const ref = useComposedRefs$14(forwardedRef, elementRef);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$14.button, {
		...
		id: inputId,
		...props,
		onPointerDown: composeEventHandlers$12(onPointerDown, () => {
...
var PasswordToggleFieldIcon = import_react.forwardRef(({ __scopePasswordToggleField, children, ...props }, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$14.svg, {
		...domProps,
		ref: forwardedRef,
		"aria-hidden": true,
		asChild: true,
...
function createSlot$13(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$13(children) && typeof use$13 === "function") children = use$13(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$13(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$13(child) && typeof use$13 === "function") child = use$13(child._payload);
				slottableElement = getSlottableElementFromSlottable$13(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$13(slottableElement) : void 0;
		const composedRef = useComposedRefs$13(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$13(ownerName) : createSlotError$13(ownerName));
			return children;
		}
		const mergedProps = mergeProps$13(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$13 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$13 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$13 = Symbol.for("react.lazy");
function isLazyComponent$13(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$13 && "_payload" in element && isPromiseLike$13(element._payload);
}
function isPromiseLike$13(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$13 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$13 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$13 = import_react[" use ".trim().toString()];
//#endregion
...
//#endregion
//#region ../../node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$10 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-popover/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$9 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$10;
function useControllableState$9({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$9({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$13(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$9({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
	useInsertionEffect$9(() => {
		onChangeRef.current = onChange;
	}, [onChange]);
	import_react.useEffect(() => {
		if (prevValueRef.current !== value) {
...
var Popover = (props) => {
	...
	const [open, setOpen] = useControllableState$9({
		prop: openProp,
		defaultProp: defaultOpen ?? false,
		onChange: onOpenChange,
		caller: POPOVER_NAME
...
var PopoverTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	const popperScope = usePopperScope$2(__scopePopover);
	const composedTriggerRef = useComposedRefs$13(forwardedRef, context.triggerRef);
	const trigger = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$13.button, {
		type: "button",
		...
		onClick: composeEventHandlers$11(props.onClick, context.onOpenToggle)
	});
...
var Slot$2 = /* @__PURE__ */ createSlot$13("PopoverContent.RemoveScroll");
var PopoverContentModal = import_react.forwardRef((props, forwardedRef) => {
	const context = usePopoverContext(CONTENT_NAME$3, props.__scopePopover);
	const contentRef = import_react.useRef(null);
	const composedRefs = useComposedRefs$13(forwardedRef, contentRef);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReactRemoveScroll, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverContentImpl, {
			...
			onCloseAutoFocus: composeEventHandlers$11(props.onCloseAutoFocus, (event) => {
				event.preventDefault();
				if (!isRightClickOutsideRef.current) context.triggerRef.current?.focus();
			}),
			onPointerDownOutside: composeEventHandlers$11(props.onPointerDownOutside, (event) => {
				const originalEvent = event.detail.originalEvent;
				const ctrlLeftClick = originalEvent.button === 0 && originalEvent.ctrlKey === true;
				const isRightClick = originalEvent.button === 2 || ctrlLeftClick;
				isRightClickOutsideRef.current = isRightClick;
			}, { checkForDefaultPrevented: false }),
			onFocusOutside: composeEventHandlers$11(props.onFocusOutside, (event) => event.preventDefault(), { checkForDefaultPrevented: false })
		})
	});
});
...
var PopoverClose = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$13.button, {
		type: "button",
		...closeProps,
		ref: forwardedRef,
		onClick: composeEventHandlers$11(props.onClick, () => context.onOpenChange(false))
	});
});
...
//#endregion
//#region ../../node_modules/@radix-ui/react-progress/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
function createSlot$12(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$12(children) && typeof use$12 === "function") children = use$12(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$12(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$12(child) && typeof use$12 === "function") child = use$12(child._payload);
				slottableElement = getSlottableElementFromSlottable$12(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$12(slottableElement) : void 0;
		const composedRef = useComposedRefs$12(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$12(ownerName) : createSlotError$12(ownerName));
			return children;
		}
		const mergedProps = mergeProps$12(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$12 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$12 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$12 = Symbol.for("react.lazy");
function isLazyComponent$12(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$12 && "_payload" in element && isPromiseLike$12(element._payload);
}
function isPromiseLike$12(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$12 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$12 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$12 = import_react[" use ".trim().toString()];
//#endregion
...
var Progress = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProgressProvider, {
		...
		value,
		max,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$12.div, {
			"aria-valuemax": max,
			"aria-valuemin": 0,
...
var ProgressIndicator = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$12.div, {
...
function createSlot$11(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$11(children) && typeof use$11 === "function") children = use$11(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$11(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$11(child) && typeof use$11 === "function") child = use$11(child._payload);
				slottableElement = getSlottableElementFromSlottable$11(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$11(slottableElement) : void 0;
		const composedRef = useComposedRefs$11(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$11(ownerName) : createSlotError$11(ownerName));
			return children;
		}
		const mergedProps = mergeProps$11(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$11 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$11 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$11 = Symbol.for("react.lazy");
function isLazyComponent$11(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$11 && "_payload" in element && isPromiseLike$11(element._payload);
}
function isPromiseLike$11(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$11 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$11 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$11 = import_react[" use ".trim().toString()];
//#endregion
...
//#endregion
//#region ../../node_modules/@radix-ui/react-radio-group/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$9 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-radio-group/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$8 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$9;
function useControllableState$8({ prop, defaultProp, onChange = () => {}, caller }) {
	const [uncontrolledProp, setUncontrolledProp, onChangeRef] = useUncontrolledState$8({
		defaultProp,
		onChange
	});
	const isControlled = prop !== void 0;
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$12(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$8({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
	useInsertionEffect$8(() => {
		onChangeRef.current = onChange;
	}, [onChange]);
	import_react.useEffect(() => {
		if (prevValueRef.current !== value) {
...
function RadioProvider(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioProviderImpl, {
		scope: __scopeRadio,
		...context,
		children: isFunction$11(internal_do_not_use_render) ? internal_do_not_use_render(context) : children
	});
}
...
var RadioTrigger = import_react.forwardRef(({ __scopeRadio, onClick, ...radioProps }, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$11(forwardedRef, setControl);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$11.button, {
		...
		...radioProps,
		ref: composedRefs,
		onClick: composeEventHandlers$10(onClick, (event) => {
			if (!checked) onCheck();
			if (bubbleInput && isFormControl) {
				hasConsumerStoppedPropagationRef.current = event.isPropagationStopped();
				if (!hasConsumerStoppedPropagationRef.current) event.stopPropagation();
...
var RadioIndicator = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$11.span, {
...
var RadioBubbleInput = import_react.forwardRef(({ __scopeRadio, ...props }, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$11(forwardedRef, setBubbleInput);
	const prevChecked = usePrevious(checked);
	const controlSize = useSize(control);
	import_react.useEffect(() => {
		const input = bubbleInput;
...
var RadioGroup = import_react.forwardRef((props, forwardedRef) => {
	...
	const direction = useDirection(dir);
	const [value, setValue] = useControllableState$8({
		prop: valueProp,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioGroupProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$7, {
			...
			dir: direction,
			loop,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$11.div, {
				role: "radiogroup",
				"aria-required": required,
...
var RadioGroupItemTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$11(forwardedRef, ref);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item$1, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RadioTrigger, {
			...
			...triggerProps,
			ref: composedRefs,
			onKeyDown: composeEventHandlers$10(triggerProps.onKeyDown, (event) => {
				if (event.key === "Enter") event.preventDefault();
			}),
			onFocus: composeEventHandlers$10(triggerProps.onFocus, () => {
...
function createSlot$10(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$10(children) && typeof use$10 === "function") children = use$10(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$10(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$10(child) && typeof use$10 === "function") child = use$10(child._payload);
				slottableElement = getSlottableElementFromSlottable$10(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$10(slottableElement) : void 0;
		const composedRef = useComposedRefs$10(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$10(ownerName) : createSlotError$10(ownerName));
			return children;
		}
		const mergedProps = mergeProps$10(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$10 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$10 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$10 = Symbol.for("react.lazy");
function isLazyComponent$10(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$10 && "_payload" in element && isPromiseLike$10(element._payload);
}
function isPromiseLike$10(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$10 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$10 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$10 = import_react[" use ".trim().toString()];
//#endregion
...
var useLayoutEffect2$8 = globalThis?.document ? import_react.useLayoutEffect : () => {};
typeof window !== "undefined" && window.document && window.document.createElement;
...
var ScrollArea = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$10(forwardedRef, setScrollArea);
	const direction = useDirection(dir);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollAreaProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$10.div, {
			dir: direction,
			...scrollAreaProps,
			ref: composedRefs,
			style: {
...
var ScrollAreaViewport = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$10(forwardedRef, import_react.useRef(null), context.onViewportChange);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollAreaViewportStyle, { nonce }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$10.div, {
...
var ScrollAreaScrollbarScroll = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarVisible, {
			...
			...scrollbarProps,
			ref: forwardedRef,
			onPointerEnter: composeEventHandlers$9(props.onPointerEnter, () => send("POINTER_ENTER")),
			onPointerLeave: composeEventHandlers$9(props.onPointerLeave, () => send("POINTER_LEAVE"))
		})
	});
});
...
var ScrollAreaScrollbarX = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composeRefs = useComposedRefs$10(forwardedRef, ref, context.onScrollbarXChange);
	import_react.useEffect(() => {
...
var ScrollAreaScrollbarY = import_react.forwardRef((props, forwardedRef) => {
	...
	const [computedStyle, setComputedStyle] = import_react.useState();
	const ref = import_react.useRef(null);
	const composeRefs = useComposedRefs$10(forwardedRef, ref, context.onScrollbarYChange);
	import_react.useEffect(() => {
		if (ref.current) setComputedStyle(getComputedStyle(ref.current));
	}, [ref]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollAreaScrollbarImpl, {
...
var ScrollAreaScrollbarImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const composeRefs = useComposedRefs$10(forwardedRef, setScrollbar);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollbarProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$10.div, {
			...
			onPointerDown: composeEventHandlers$9(props.onPointerDown, (event) => {
				if (event.button === 0) {
			...
			onPointerMove: composeEventHandlers$9(props.onPointerMove, handleDragScroll),
			onPointerUp: composeEventHandlers$9(props.onPointerUp, (event) => {
				const element = event.target;
...
var ScrollAreaThumbImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRef = useComposedRefs$10(forwardedRef, scrollbarContext.onThumbChange);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$10.div, {
		...
		onPointerDownCapture: composeEventHandlers$9(props.onPointerDownCapture, (event) => {
		...
		onPointerUp: composeEventHandlers$9(props.onPointerUp, scrollbarContext.onThumbPointerUp)
	});
});
...
var ScrollAreaCornerImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return hasSize ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$10.div, {
		...cornerProps,
		ref: forwardedRef,
		style: {
			width,
...
function createSlot$9(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$9(children) && typeof use$9 === "function") children = use$9(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$9(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$9(child) && typeof use$9 === "function") child = use$9(child._payload);
				slottableElement = getSlottableElementFromSlottable$9(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		else if (!hasSlottable && import_react.Children.count(children) === 1 && import_react.isValidElement(children)) slottableElement = children;
		const slottableElementRef = slottableElement ? getElementRef$9(slottableElement) : void 0;
		const composedRef = useComposedRefs$9(forwardedRef, slottableElementRef);
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$9(ownerName) : createSlotError$9(ownerName));
			return children;
		}
		const mergedProps = mergeProps$9(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$9 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$9 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$9 = Symbol.for("react.lazy");
function isLazyComponent$9(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$9 && "_payload" in element && isPromiseLike$9(element._payload);
}
function isPromiseLike$9(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$9 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$9 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$9 = import_react[" use ".trim().toString()];
//#endregion
...
var useLayoutEffect2$7 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-select/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$7 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$7;
function useControllableState$7({ prop, defaultProp, onChange = () => {}, caller }) {
	...
	return [value, import_react.useCallback((nextValue) => {
		if (isControlled) {
			const value2 = isFunction$10(nextValue) ? nextValue(prop) : nextValue;
			if (value2 !== prop) onChangeRef.current?.(value2);
		} else setUncontrolledProp(nextValue);
	}, [
		isControlled,
...
function useUncontrolledState$7({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
function SelectProvider(props) {
	...
	const direction = useDirection(dir);
	const [open, setOpen] = useControllableState$7({
		prop: openProp,
		defaultProp: defaultOpen ?? false,
		onChange: onOpenChange,
		caller: SELECT_NAME
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectProviderImpl, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$2.Provider, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectNativeOptionsProvider, {
					...
					children: isFunction$9(internal_do_not_use_render) ? internal_do_not_use_render(context) : children
				})
			})
		})
	});
...
var SelectTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	const isDisabled = context.disabled || disabled;
	const composedRefs = useComposedRefs$9(forwardedRef, context.onTriggerChange);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Anchor, {
		asChild: true,
		...popperScope,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$9.button, {
			type: "button",
			role: "combobox",
			"aria-controls": context.open ? context.contentId : void 0,
			"aria-expanded": context.open,
			...
			...triggerProps,
			ref: composedRefs,
			onClick: composeEventHandlers$8(triggerProps.onClick, (event) => {
				event.currentTarget.focus();
				if (pointerTypeRef.current !== "mouse") handleOpen(event);
			}),
			onPointerDown: composeEventHandlers$8(triggerProps.onPointerDown, (event) => {
			...
			onKeyDown: composeEventHandlers$8(triggerProps.onKeyDown, (event) => {
...
var SelectValue = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$9(forwardedRef, context.onValueNodeChange);
	useLayoutEffect2$7(() => {
		onValueNodeHasChildrenChange(hasChildren);
	}, [onValueNodeHasChildrenChange, hasChildren]);
	const showPlaceholder = shouldShowPlaceholder(context.value);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$9.span, {
		...valueProps,
...
var Slot$1 = /* @__PURE__ */ createSlot$9("SelectContent.RemoveScroll");
var SelectContentImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const [content, setContent] = import_react.useState(null);
	const [viewport, setViewport] = import_react.useState(null);
	const composedRefs = useComposedRefs$9(forwardedRef, setContent);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContentProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReactRemoveScroll, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusScope, {
				...
				onUnmountAutoFocus: composeEventHandlers$8(onCloseAutoFocus, (event) => {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DismissableLayer, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectPosition, {
						...
						onKeyDown: composeEventHandlers$8(contentProps.onKeyDown, (event) => {
							const isModifierKey = event.ctrlKey || event.altKey || event.metaKey;
							if (event.key === "Tab") event.preventDefault();
...
var SelectItemAlignedPosition = import_react.forwardRef((props, forwardedRef) => {
	...
	useLayoutEffect2$7(() => position(), [position]);
	const [contentZIndex, setContentZIndex] = import_react.useState();
	useLayoutEffect2$7(() => {
		if (content) setContentZIndex(window.getComputedStyle(content).zIndex);
	}, [content]);
...
var SelectViewport = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$9(forwardedRef, contentContext.onViewportChange);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("style", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$9.div, {
			...
			onScroll: composeEventHandlers$8(viewportProps.onScroll, (event) => {
...
var SelectItem = import_react.forwardRef((props, forwardedRef) => {
	...
	const [isFocused, setIsFocused] = import_react.useState(false);
	const composedRefs = useComposedRefs$9(forwardedRef, useCallbackRef((node) => contentContext.itemRefCallback?.(node, value, disabled)));
	const textId = useId();
	const pointerTypeRef = import_react.useRef("touch");
	const handleSelect = () => {
		if (!disabled) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItemContextProvider, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$2.ItemSlot, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$9.div, {
				...
				...itemProps,
				ref: composedRefs,
				onFocus: composeEventHandlers$8(itemProps.onFocus, () => setIsFocused(true)),
				onBlur: composeEventHandlers$8(itemProps.onBlur, () => setIsFocused(false)),
				onClick: composeEventHandlers$8(itemProps.onClick, () => {
					if (pointerTypeRef.current !== "mouse") handleSelect();
				}),
				onPointerUp: composeEventHandlers$8(itemProps.onPointerUp, () => {
					if (pointerTypeRef.current === "mouse") handleSelect();
				}),
				onPointerDown: composeEventHandlers$8(itemProps.onPointerDown, (event) => {
					pointerTypeRef.current = event.pointerType;
				}),
				onPointerMove: composeEventHandlers$8(itemProps.onPointerMove, (event) => {
					pointerTypeRef.current = event.pointerType;
					if (disabled) contentContext.onItemLeave?.();
					else if (pointerTypeRef.current === "mouse") event.currentTarget.focus({ preventScroll: true });
				}),
				onPointerLeave: composeEventHandlers$8(itemProps.onPointerLeave, (event) => {
					if (event.currentTarget === document.activeElement) contentContext.onItemLeave?.();
				}),
				onKeyDown: composeEventHandlers$8(itemProps.onKeyDown, (event) => {
...
var SelectItemText = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$9(forwardedRef, setItemTextNode, itemContext.onItemTextChange, handleItemTextRefCallback);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$9.span, {
...
var SelectItemIndicator = import_react.forwardRef((props, forwardedRef) => {
	...
	return useSelectItemContext(ITEM_INDICATOR_NAME, __scopeSelect).isSelected ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$9.span, {
		"aria-hidden": true,
		...itemIndicatorProps,
		ref: forwardedRef
	}) : null;
...
var SelectScrollUpButton = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$9(forwardedRef, viewportContext.onScrollButtonChange);
	useLayoutEffect2$7(() => {
...
var SelectScrollButtonImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$9.div, {
		...
		onPointerDown: composeEventHandlers$8(scrollIndicatorProps.onPointerDown, () => {
			if (autoScrollTimerRef.current === null) autoScrollTimerRef.current = window.setInterval(onAutoScroll, 50);
		}),
		onPointerMove: composeEventHandlers$8(scrollIndicatorProps.onPointerMove, () => {
			contentContext.onItemLeave?.();
			if (autoScrollTimerRef.current === null) autoScrollTimerRef.current = window.setInterval(onAutoScroll, 50);
		}),
		onPointerLeave: composeEventHandlers$8(scrollIndicatorProps.onPointerLeave, () => {
			clearAutoScrollTimer();
		})
	});
});
...
var SelectBubbleInput = import_react.forwardRef(({ __scopeSelect, ...props }, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Primitive$9.select, {
		"aria-hidden": true,
		required,
		tabIndex: -1,
		name,
...
function createSlot$8(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		let hasSlottable = false;
		const newChildren = [];
		if (isLazyComponent$8(children) && typeof use$8 === "function") children = use$8(children._payload);
		import_react.Children.forEach(children, (maybeSlottable) => {
			if (isSlottable$8(maybeSlottable)) {
				hasSlottable = true;
				const slottable = maybeSlottable;
				let child = "child" in slottable.props ? slottable.props.child : slottable.props.children;
				if (isLazyComponent$8(child) && typeof use$8 === "function") child = use$8(child._payload);
				slottableElement = getSlottableElementFromSlottable$8(slottable, child);
				newChildren.push(slottableElement?.props?.children);
			} else newChildren.push(maybeSlottable);
		});
		if (slottableElement) slottableElement = import_react.cloneElement(slottableElement, void 0, newChildren);
		...
		if (!slottableElement) {
			if (children || children === 0) throw new Error(hasSlottable ? createSlottableError$8(ownerName) : createSlotError$8(ownerName));
			return children;
		}
		const mergedProps = mergeProps$8(slotProps, slottableElement.props ?? {});
		if (slottableElement.type !== import_react.Fragment) mergedProps.ref = forwardedRef ? composedRef : slottableElementRef;
		return import_react.cloneElement(slottableElement, mergedProps);
	});
	Slot2.displayName = `${ownerName}.Slot`;
...
var SLOTTABLE_IDENTIFIER$8 = Symbol.for("radix.slottable");
var getSlottableElementFromSlottable$8 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var REACT_LAZY_TYPE$8 = Symbol.for("react.lazy");
function isLazyComponent$8(element) {
	return element != null && typeof element === "object" && "$$typeof" in element && element.$$typeof === REACT_LAZY_TYPE$8 && "_payload" in element && isPromiseLike$8(element._payload);
}
function isPromiseLike$8(value) {
	return typeof value === "object" && value !== null && "then" in value;
}
var createSlotError$8 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$8 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
var use$8 = import_react[" use ".trim().toString()];
//#endregion
...
var Separator$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$8.div, {
		"data-orientation": orientation,
		...semanticProps,
		...domProps,
		ref: forwardedRef
...
var useLayoutEffect2$6 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-slider/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$6 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$6;
function useControllableState$6({ prop, defaultProp, onChange = () => {}, caller }) {
...
function useUncontrolledState$6({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
var getSlottableElementFromSlottable$7 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var createSlotError$7 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$7 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
...
var Slider = import_react.forwardRef((props, forwardedRef) => {
	...
	const [values = [], setValues] = useControllableState$6({
		prop: value,
		defaultProp: defaultValue,
		onChange: (value2) => {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$1.Provider, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$1.Slot, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderOrientation, {
					...
					...sliderProps,
					ref: forwardedRef,
					onPointerDown: composeEventHandlers$7(sliderProps.onPointerDown, () => {
						if (!disabled) {
...
var SliderHorizontal = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$7(forwardedRef, setSlider);
...
var SliderVertical = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = useComposedRefs$7(forwardedRef, sliderRef);
	const rectRef = import_react.useRef(void 0);
...
var SliderImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$7.span, {
		...sliderProps,
		ref: forwardedRef,
		...
		onPointerDown: composeEventHandlers$7(props.onPointerDown, (event) => {
			const target = event.target;
		...
		onPointerMove: composeEventHandlers$7(props.onPointerMove, (event) => {
			if (event.target.hasPointerCapture(event.pointerId)) onSlideMove(event);
		}),
		onPointerUp: composeEventHandlers$7(props.onPointerUp, (event) => {
			const target = event.target;
...
var SliderRange = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$7(forwardedRef, import_react.useRef(null));
...
function SliderThumbProvider(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SliderThumbContextProvider, {
		scope: __scopeSlider,
		...thumbContext,
		children: isFunction$7(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children
	});
}
...
var SliderThumbTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$7(forwardedRef, onThumbChange);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$1.ItemSlot, {
			scope: __scopeSlider,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$7.span, {
				role: "slider",
...
var SliderBubbleInput = import_react.forwardRef(({ __scopeSlider, ...props }, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$7(ref, forwardedRef);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$7.input, {
		style: { display: "none" },
		name,
		form,
		...props,
...
function createSlot$6(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		const slottableElementRef = slottableElement ? getElementRef$6(slottableElement) : void 0;
...
var getSlottableElementFromSlottable$6 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var createSlotError$6 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$6 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
...
var useLayoutEffect2$5 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-switch/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$5 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$5;
function useControllableState$5({ prop, defaultProp, onChange = () => {}, caller }) {
...
function useUncontrolledState$5({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
var getSlottableElementFromSlottable$5 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var createSlotError$5 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$5 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
...
function SwitchProvider(props) {
	...
	const [checked, setChecked] = useControllableState$5({
		prop: checkedProp,
		defaultProp: defaultChecked ?? false,
		onChange: onCheckedChange,
		caller: SWITCH_NAME
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SwitchProviderImpl, {
		scope: __scopeSwitch,
		...context,
		children: isFunction$5(internal_do_not_use_render) ? internal_do_not_use_render(context) : children
	});
}
...
var SwitchTrigger = import_react.forwardRef(({ __scopeSwitch, onClick, ...switchProps }, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$5(forwardedRef, setControl);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$6.button, {
		type: "button",
		role: "switch",
		"aria-checked": checked,
		"aria-required": required,
		...
		...switchProps,
		ref: composedRefs,
		onClick: composeEventHandlers$6(onClick, (event) => {
...
var SwitchBubbleInput = import_react.forwardRef(({ __scopeSwitch, ...props }, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$5(forwardedRef, setBubbleInput);
	const prevChecked = usePrevious(checked);
	const controlSize = useSize(control);
	import_react.useEffect(() => {
		const input = bubbleInput;
...
//#endregion
//#region ../../node_modules/@radix-ui/react-tabs/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
function createSlot$4(ownerName) {
	const Slot2 = import_react.forwardRef((props, forwardedRef) => {
		...
		const composedRef = useComposedRefs$4(forwardedRef, slottableElementRef);
		if (!slottableElement) {
...
var getSlottableElementFromSlottable$4 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var createSlotError$4 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$4 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
...
//#endregion
//#region ../../node_modules/@radix-ui/react-tabs/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$4 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-tabs/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$4 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$4;
function useControllableState$4({ prop, defaultProp, onChange = () => {}, caller }) {
...
function useUncontrolledState$4({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
var Tabs = import_react.forwardRef((props, forwardedRef) => {
	...
	const direction = useDirection(dir);
	const [value, setValue] = useControllableState$4({
		prop: valueProp,
		onChange: onValueChange,
		defaultProp: defaultValue ?? "",
		caller: TABS_NAME
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TabsProvider, {
		...
		dir: direction,
		activationMode,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$5.div, {
			dir: direction,
			"data-orientation": orientation,
			...tabsProps,
			ref: forwardedRef
...
var TabsTrigger = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Item$1, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$5.button, {
			...
			...triggerProps,
			ref: forwardedRef,
			onMouseDown: composeEventHandlers$5(props.onMouseDown, (event) => {
...
var TabsContent = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		...
		children: ({ present }) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$5.div, {
			"data-state": isSelected ? "active" : "inactive",
			"data-orientation": context.orientation,
			role: "tabpanel",
			"aria-labelledby": triggerId,
...
var getSlottableElementFromSlottable$3 = (slottable, child) => {
	if ("child" in slottable.props) {
		const child2 = slottable.props.child;
		if (!import_react.isValidElement(child2)) return null;
		return import_react.cloneElement(child2, void 0, slottable.props.children(child2.props.children));
...
var createSlotError$3 = (ownerName) => {
	return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
};
var createSlottableError$3 = (ownerName) => {
	return `${ownerName} failed to slot onto its \`Slottable\`. Expected \`Slottable\` to receive a single React element child.`;
};
...
var useLayoutEffect2$3 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-toast/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$3 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$3;
function useControllableState$3({ prop, defaultProp, onChange = () => {}, caller }) {
...
function useUncontrolledState$3({ defaultProp, onChange }) {
	const [value, setValue] = import_react.useState(defaultProp);
	const prevValueRef = import_react.useRef(value);
	const onChangeRef = import_react.useRef(onChange);
...
var ToastViewport = import_react.forwardRef((props, forwardedRef) => {
	...
	const ref = import_react.useRef(null);
	const composedRefs = useComposedRefs$3(forwardedRef, ref, context.onViewportChange);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Branch, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.Slot, {
				scope: __scopeToast,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$4.ol, {
					tabIndex: -1,
					...viewportProps,
					ref: composedRefs
				})
...
var Toast = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Presence, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToastImpl, {
			...
			onSwipeStart: composeEventHandlers$4(props.onSwipeStart, (event) => {
				event.currentTarget.setAttribute("data-swipe", "start");
			}),
			onSwipeMove: composeEventHandlers$4(props.onSwipeMove, (event) => {
				const { x, y } = event.detail.delta;
				event.currentTarget.setAttribute("data-swipe", "move");
				event.currentTarget.style.setProperty("--radix-toast-swipe-move-x", `${x}px`);
				event.currentTarget.style.setProperty("--radix-toast-swipe-move-y", `${y}px`);
			}),
			onSwipeCancel: composeEventHandlers$4(props.onSwipeCancel, (event) => {
			...
			onSwipeEnd: composeEventHandlers$4(props.onSwipeEnd, (event) => {
				const { x, y } = event.detail.delta;
...
var ToastImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	const composedRefs = useComposedRefs$3(forwardedRef, setNode);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [announceTextContent && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToastAnnounce, {
		...
		children: import_react_dom.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection.ItemSlot, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Root$12, {
				asChild: true,
				onEscapeKeyDown: composeEventHandlers$4(onEscapeKeyDown, () => {
					if (!context.isFocusedToastEscapeKeyDownRef.current) handleClose();
					context.isFocusedToastEscapeKeyDownRef.current = false;
				}),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$4.li, {
					tabIndex: 0,
					"data-state": open ? "open" : "closed",
...
var ToastClose = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToastAnnounceExclude, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$4.button, {
			...
			...closeProps,
			ref: forwardedRef,
			onClick: composeEventHandlers$4(props.onClick, interactiveContext.onClose)
		})
	});
});
...
//#endregion
//#region ../../node_modules/radix-ui/node_modules/@radix-ui/react-use-layout-effect/dist/index.mjs
var useLayoutEffect2$2 = globalThis?.document ? import_react.useLayoutEffect : () => {};
import_react[" useEffectEvent ".trim().toString()];
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/radix-ui/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
var useInsertionEffect$2 = import_react[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$2;
...
//#endregion
//#region ../../node_modules/radix-ui/node_modules/@radix-ui/react-toggle/dist/index.mjs
...
var Toggle$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	const [pressed, setPressed] = useControllableState$2({
		prop: pressedProp,
		onChange: onPressedChange,
		defaultProp: defaultPressed ?? false,
		caller: NAME$1
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$3.button, {
		type: "button",
...
var Root = Toggle$1;
//#endregion
//#region ../../node_modules/@radix-ui/react-toggle-group/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
//#endregion
//#region ../../node_modules/@radix-ui/react-toggle-group/node_modules/@radix-ui/react-toggle/dist/index.mjs
var NAME = "Toggle";
...
var ToggleGroupImpl = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ToggleGroupContext, {
		...
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$2.div, {
			...commonProps,
			ref: forwardedRef
		})
	});
...
//#endregion
//#region ../../node_modules/@radix-ui/react-toolbar/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
import_react[" useInsertionEffect ".trim().toString()];
//#endregion
//#region ../../node_modules/@radix-ui/react-tooltip/node_modules/@radix-ui/react-use-controllable-state/dist/index.mjs
